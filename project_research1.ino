...
if(digitalRead(button_4)== HIGH)
{
  ...
  long int hours1 = Serial.parseInt();
  lcd.print(hours1);
  lcd.print(" : ");
  Serial.println("(minutes) : ");
  while (Serial.available()==0){}            
  long int mins1 = Serial.parseInt(); 
  lcd.print(mins1);
  lcd.print(" : ");
  Serial.println("(seconds) : ");
  while (Serial.available()==0){}            
  long int seconds1 = Serial.parseInt(); 
  lcd.print(seconds1);
  lcd.clear();
  
  long int med_time1 =(hours1*3600)+(mins1*60)+(seconds1);
   	lcd.print(med_time1);
   	delay(300);
   	lcd.clear();
  ...
  Serial.println("(hours) : ");
  while (Serial.available()==0){}            
  long int hours2 = Serial.parseInt();
  lcd.print(hours2);
  lcd.print(" : ");
  Serial.println("(minutes) : ");
  while (Serial.available()==0){}            
  long int mins2 = Serial.parseInt(); 
  lcd.print(mins2);
  lcd.print(" : ");
  Serial.println("(seconds) : ");
  while (Serial.available()==0){}            
  long int seconds2 = Serial.parseInt(); 
  lcd.print(seconds2);
  lcd.clear();
  
  long int med_time2 =(hours2*3600)+(mins2*60)+(seconds2);
   	lcd.print(med_time2);
   	delay(400);
   	lcd.clear();  
  ...
  digitalWrite(buzzerpin,LOW);
    ...
    if(i<med_time1 ){
      lcd.clear();
       lcd.setCursor(0,0);
       lcd.print(med_time1-i );
       lcd.setCursor(0,1);
       lcd.print("seconds");
       delay(1000);
       lcd.clear();
       }
    else if (i>med_time1 && i<med_time2){
     lcd.clear();
     lcd.setCursor(0,0);
     lcd.print( med_time2-i);
     lcd.setCursor(0,1);
     lcd.print("seconds");
     delay(1000);
     lcd.clear();
